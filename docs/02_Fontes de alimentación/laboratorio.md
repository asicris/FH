...
5. **Coloca a fonte nun luear ben iluminado e estable.**
   - Non a poñas en verticle, colócaa horizontal para acceder mellor aos pins.
...
### Exercicio: Medición Completa dunha Fonte
...
- Óculos de seguridade

**Protocolo:**

1. **Prepárate con seguridade** (sección 2).
2. **Mide todas as voltaxes** usando o Método A ou B (sección 3).
...
5. **Fotografía (Opcional):**
   - Toma unha foto do Power Supply Tester con os valores mostrados.
   - Toma unha foto das medidas do multímetro (se usas este método).
